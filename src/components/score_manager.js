      ...
      <div className={styles.container}>
        ...
        <div className={styles.bottomContainer}>
          <div className={styles.columnContainer}>
            ...
            <div className={styles.firstColumnItem}>돌집 (2점)</div>
          ...
          <div className={styles.columnContainer}>
            ...
            <div className={styles.middleColumnItem}>
            ...
            <div className={styles.middleColumnItem}>12</div>
            <div className={styles.middleColumnItem}>13</div>
            <div className={styles.middleColumnItem}>14</div>
            <div className={styles.middleColumnItem}>15</div>
            <div className={styles.middleColumnLastItem}>16</div>
          </div>
          <div className={styles.columnContainer}>
          ...
          <div className={styles.columnContainer}>
            ...
            <div className={styles.finalColumnItem}>12</div>
            <div className={styles.finalColumnItem}>13</div>
            <div className={styles.finalColumnItem}>14</div>
            <div className={styles.finalColumnItem}>15</div>
            <div className={styles.finalColumnLastItem}>16</div>
          </div>
        </div>
      </div>
    </div>
